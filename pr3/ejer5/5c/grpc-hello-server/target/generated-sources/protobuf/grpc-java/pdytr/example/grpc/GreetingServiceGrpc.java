...
public final class GreetingServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<pdytr.example.grpc.GreetingServiceOuterClass.Time,
      pdytr.example.grpc.GreetingServiceOuterClass.Response> METHOD_GREETING =
      io.grpc.MethodDescriptor.<pdytr.example.grpc.GreetingServiceOuterClass.Time, pdytr.example.grpc.GreetingServiceOuterClass.Response>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "pdytr.example.grpc.GreetingService", "greeting"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              pdytr.example.grpc.GreetingServiceOuterClass.Time.getDefaultInstance()))
  ...
  public static abstract class GreetingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void greeting(pdytr.example.grpc.GreetingServiceOuterClass.Time request,
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                pdytr.example.grpc.GreetingServiceOuterClass.Time,
  ...
  public static final class GreetingServiceBlockingStub extends io.grpc.stub.AbstractStub<GreetingServiceBlockingStub> {
    ...
    /**
     */
    public pdytr.example.grpc.GreetingServiceOuterClass.Response greeting(pdytr.example.grpc.GreetingServiceOuterClass.Time request) {
  ...
  public static final class GreetingServiceFutureStub extends io.grpc.stub.AbstractStub<GreetingServiceFutureStub> {
    ...
    public com.google.common.util.concurrent.ListenableFuture<pdytr.example.grpc.GreetingServiceOuterClass.Response> greeting(
        pdytr.example.grpc.GreetingServiceOuterClass.Time request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GREETING:
          serviceImpl.greeting((pdytr.example.grpc.GreetingServiceOuterClass.Time) request,
              (io.grpc.stub.StreamObserver<pdytr.example.grpc.GreetingServiceOuterClass.Response>) responseObserver);
          break;
        default:
